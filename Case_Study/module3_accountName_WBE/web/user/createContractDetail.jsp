...
<div>
    ...
    <form method="post" novalidate>
        ...
        <table>
            <tr>
                <td>ID Hợp đồng chi tiết:</td>
                <td><input type="text" name="idDetail" autocomplete="no"
                required pattern="^HD-[0-9]{4}$" >
                </td>
                <div class="invalid-feedback">Example HD-1234</div>
            </tr>
            <tr>
                <td>ID Hợp đồng</td>
            ...
            <tr>
                <td align="center" colspan="2">
                    <a href="/furama?action=createcontractdetail"><input type="button" value="Xoá"></a>
