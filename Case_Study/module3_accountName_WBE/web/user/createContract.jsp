...
<div>
    <a href="/furama?action=createcontract">Back</a>
    <form method="post">
        <h3>
            Thêm mới Hợp Đồng!!!
        </h3>
        <table>
            ...
            <tr>
                <td>Ngày bắt đầu(YYYY-MM-DD): </td>
                <td><input type="text" name="startDate"></td>
            </tr>
            <tr>
                <td>Ngày kết thúc(YYYY-MM-DD): </td>
            ...
            <tr>
                ...
                <td><input type="text" name="attachServiceId"></td>
            </tr>
            <tr>
                <td>Số lượng: </td>
            ...
            <tr>
                <td rowspan="2" style="vertical-align: bottom">
                    <a href="/furama?action=createcontractdetail" style="color: azure;font-size: medium; font-size: medium ">Thêm Hợp đồng chi tiết!</a>
                </td>
            </tr>

            <tr>
                <td align="center" colspan="2">
                    <a href="/furama?action=createcontract"><input type="button" value="Xoá"></a>
